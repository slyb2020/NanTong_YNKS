...
class ProductionScheduleDialog(wx.Dialog):
    def __init__(self, parent, log, orderID, size=wx.DefaultSize, pos=wx.DefaultPosition,
        ...
        self.tempButton = wx.Button(controlPanel,label="打开",size=(100,30))
        self.tempButton.Bind(wx.EVT_BUTTON, self.OnOpenFileBTN)
        vbox.Add(hbox, 0, wx.EXPAND)
        vbox.Add((-1,10))
        vbox.Add(self.tempButton,0,wx.EXPAND|wx.ALL,10)
